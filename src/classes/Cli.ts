  ...
  findVehicleToTow(towTruck: Truck): void {
    inquirer
      ...
      .then((answers) => {
        ...
        let vehicle = answers.vehicleToTow;
        if(vehicle === towTruck){
          console.log("truck can't tow itself");
          this.performActions();
          return;
        } else {
          towTruck.tow(vehicle);
        }
        this.performActions();
      });
  }
  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // findVehicleToTow method to find a vehicle to tow and pass the selected truck as an argument. After 
        // calling the findVehicleToTow method, you will need to return to avoid instantly calling the 
        // performActions method again since findVehicleToTow is asynchronous.

        else if (answers.action === 'Tow'){
          let suceeded: boolean = false;
